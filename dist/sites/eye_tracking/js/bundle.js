...
function Vector(x, y) {
	...
	this.clamp = function(minVector, maxVector){
		this.x = clamp(this.x, minVector.x, maxVector.x);
		this.y = clamp(this.y, minVector.y, maxVector.y);
	}
}
